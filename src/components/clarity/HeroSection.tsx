  ...
  return (
    <div className="bg-hero h-screen bg-cover bg-center ">
      ...
      <div className="flex flex-col justify-center items-center mt-10">
        ...
        <div className=" flex flex-col items-center w-7/12 mt-8">
        <div>
          <h2 className="text-white text-5xl text-center my-2 border rounded-2xl p-2"> Lorem ipsum dolor sit amet, consectetur adipiscing elit lorem ipsum,</h2>
        </div>
        <div className="w-100 rounded h-2 bg-gradient-to-r from-green-50 to-green-950 my-5"></div>
          <h6 className="text-center font-extrabold text-white text-4xl mb-5">
          ...
          <p className="text-center text-white text-2xl mt-4 my-5 font-semibold"> Auteur de projets ambitieux et innovants, la société tend rapidement à s’imposer comme l’un des Majors 
