    ...
    <div className='flex items-center justify-between w-full h-full p-5'>
        ...
        <div className='w-1/2'>
            <div className='flex items-center justify-between'>
                <div className="w-50 h-2 bg-gradient-to-r from-green-950  to-green-800  mb-5"></div>
            ...
            <p className='text-2xl text-slate-950 my-5'>Lorem ipsum dolor sit amet, consectetur 
