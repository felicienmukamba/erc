      ...
      <div className="flex flex-col justify-center items-center mt-10">
        <div className=" flex flex-col items-center ">
          <h6 className="text-center font-bold text-white text-4xl mb-5">Espace d’excellence de mise <br />
            ...
            <div className="w-50 h-1 bg-slate-50 mb-5"></div>
            <p className="text-center text-white text-2xl mt-4 my-5">Nous vous accompagnons dans vos projets de construction.</p>

        </div>
        <div className="my-4">
            <p className="text-white text-center">Un service de construction qui répond aux normes architecturales</p>
        </div>
        <div className="flex justify-center text-white">
            <button className="w-44 mx-4 h-12 border rounded-2xl hover:bg-green-700">Lorem ipsum</button>
            <button className="w-44 mx-4 h-12 bg-slate-50 text-slate-950 rounded-2xl hover:bg-gray-300">Lorem ipsum</button>
        </div>
      </div>
    </div>
  )
