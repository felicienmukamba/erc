...
const PartnerSection = () => {
  ...
  return (
    <div className="bg-slate-50 opacity-65 mt-[-80px] flex flex-col items-center justify-center w-[80%] mx-auto rounded-xl p-1">
            ...
            <CarouselContent>
                {
                    partners.map((partner, index)=> (
                        <CarouselItem key={index} className="md:basis-1/3 lg:basis-1/4 sm:basis-1/4">
                        <div className="p-1">
                        <Card>
